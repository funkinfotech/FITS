            ...
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
                ...
                <tr>
                    <td style="padding-bottom: 20px;">
                        <a href="{{ url('/') }}" style="text-decoration: none;">
                            <img src="{{ asset('images/funkit-logo.png') . '?v=2' }}" alt="FunkIT" width="28" height="28" style="vertical-align: middle; border-radius: 6px;">
                ...
                <tr>
                    <td style="background-color: #ffffff; border-radius: 10px; padding: 28px;">
                        <p style="margin: 0 0 4px; font-size: 11px; font-weight: 700; letter-spacing: 0.05em; text-transform: uppercase; color: #052a44;">Ticket opened</p>
                        ...
                        <p style="margin: 0 0 8px; font-size: 13px; color: #6b7280;">A support ticket has been opened on your behalf:</p>

                        <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin-bottom: 20px;">
                            <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #1f2937; white-space: pre-line;">{{ $ticket->message }}</p>
                        </div>
