            ...
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
                ...
                <tr>
                    <td style="background-color: #ffffff; border-radius: 10px; padding: 28px;">
                        <p style="margin: 0 0 4px; font-size: 11px; font-weight: 700; letter-spacing: 0.05em; text-transform: uppercase; color: #052a44;">Invoice</p>
                        <h1 style="margin: 0 0 4px; font-size: 20px; font-weight: 700; color: #111827;">{{ $invoice->invoice_number }}</h1>
                        <p style="margin: 0 0 20px; font-size: 13px; color: #6b7280;">Due {{ $invoice->due_date?->format('M j, Y') }}</p>

                        @if ($customMessage)
                            <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin-bottom: 20px;">
                                <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #1f2937; white-space: pre-line;">{{ $customMessage }}</p>
                            </div>
                        @endif
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
                            ...
                            <tr>
                                <td style="font-size: 13px; color: #6b7280; padding: 4px 0;">Issue Date</td>
