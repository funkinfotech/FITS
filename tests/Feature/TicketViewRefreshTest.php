...
class TicketViewRefreshTest extends TestCase
{
    ...
    public function test_view_ticket_page_reflects_status_changed_elsewhere_after_refresh_event(): void
    {
        ...
        // Simulate the status changing behind this page's back (e.g. via the
        // comments relation manager in a separate Livewire request).
